		...
		items: [
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								link: "/modules/validators/smartSessions/methods",
								text: "Methods",
								items: [
									{
										link: "/modules/validators/smartSessions/methods/grantPermission",
										text: "Grant Permission",
									},
									{
										link: "/modules/validators/smartSessions/methods/usePermission",
										text: "Use Permission",
									},
									{
										link: "/modules/validators/smartSessions/methods/grantDeferredPermission",
										text: "Grant Permission (Deferred)",
									},
								],
							},
							{
							...
							{
								link: "/modules/validators/smartSessions/demo",
								text: "Demo",
							},
						],
					},
