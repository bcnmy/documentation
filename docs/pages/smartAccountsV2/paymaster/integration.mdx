...
To see how this interacts with other packages in the sdk you can view the [Smart Accounts Integration page](/smartAccountsV2/account/integration.mdx).
...
You have now assigned the Paymaster to the smart account. See our [tutorials](/smartAccountsV2/tutorials) for in depth integrations of the Smart Account and Paymaster.
