...
Now we can send user ops and do actions like minting an NFT, the same way we did it in the [Quickstart](/nexus/quickstart) using the `k1Validator` as the validation module.
