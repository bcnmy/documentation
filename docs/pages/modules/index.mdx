...
Modules are designed to extend the functionality of smart contract accounts in a consistent and predictable manner. This guide explains how modules work and how to interact with them in the Nexus SDK.

## Module Extension Pattern

The Nexus SDK uses a module extension pattern to maintain efficient bundle sizes and enable tree-shaking. Here's why:
