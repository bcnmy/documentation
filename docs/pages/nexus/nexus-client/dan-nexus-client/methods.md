...
// @filename: config.ts
import { type UnknownSigner } from "@biconomy/sdk-canary"
...
```typescript
type SigGenResponse = {
  /** Generated distributed signature */
  signature: `0x${string}`
  /** Prepared user operation ready for submission */
...
Complete transaction flow with distributed signature validation.
...
```typescript
/** Transaction hash of the executed operation */
type Hash = `0x${string}`
```
