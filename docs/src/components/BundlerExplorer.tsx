...
export default function Explorer() {
  ...
  const validateBundlerURL = (value: string) => {
  ...
  const onSubmit: SubmitHandler<FormValues> = (data: {method: string, userOp?: any; bundlerUrl: string; userOphash?: string}) => {
      ...
      <div className="requestContainer">
        ...
        {sample && (
          <div>
            <h2>Sample Request</h2>
            <pre>
              <code className="hljs bundlerRequestBlock">
                {sample}
              </code>
            </pre>
          </div>
